...
const territoriesForCompression = ["Ragni","Emerald Trail","Ragni North Entrance","Riverbank Knoll","Ragni Countryside North","Maltic Coast","Farmers Settlement","Ragni South Entrance","Sulphuric Hollow","Time Valley","Sanctuary Bridge","Tempo Town","Nivla Woods","Blooming Boulders","Elkurn","Corrupted Road","Akias Ruins","Detlas Suburbs","Ancient Waterworks","Webbed Fracture","Tower of Ascension","Mage Island","Twain Mansion","Wolves' Den","Florist's Hut","Frosty Spikes","Icy Vigil","Great Bridge","Monte's Village","Iboju Village","Temple of Legends","Rymek","Eagle Tribe","Sunset Plateau","Invaded Barracks","Accursed Dunes","Gloopy Cave","Ancient Excavation","Mummy's Tomb","Almuj Slums","Entrance to Almuj","Savannah Plains","Lion Lair","Rocky Shore","Nested Cliffside","Ancient Nemract","Cathedral Harbour","Rooster Island","Selchar","Durum Barley Islet","Durum Malt Islet","Skien's Island","Nodguj Nation","Disturbed Crypt","Dreary Docks","Volcanic Isles","Tree Island","Black Road","Mining Base Camp","Nesaak Transition","Corrupted River","Mine Base Plains","Corrupted Warfront","Corrupted Tower","Llevigar Gate","Llevigar Stables","The Hive","Trunkstump Goblin Camp","Brigand Outpost","Collapsed Emerald Mine","Floral Peaks","Witching Road","Infested Sinkhole","Bloody Trail","Olux Lumberyard","Entrance to Olux","Swamp Mountain Arch","Scorpion Nest","Naga Lake","Karoc Quarry","Shineridge Orc Camp","Sunspark Orc Camp","Orc Road","Sablestone Orc Camp","Iron Road","Llevigar Farm","Goblin Plains East","Centerworld Fortress","Efilim","Minotaur Barbecue","Guardian of the Forest","Path to Light's Secret","Myconid Descent","Luxuriant Pond","Unicorn Trail","Collapsed Bridge","The Shiar","Chasm Overlook","Enchanted River","Gelibord Watermill","Fading Forest","Mangled Lake","Twisted Housing","Path to the Penitentiary","Faltach Manor","Kander Mines","Viscera Pits","Talor Cemetery","Lexdale","Decayed Basin","Entrance to Cinfras","Weird Clearing","Guild Hall","Cinfras's Small Farm","Silverbull Headquarters","Gylia Fisherman Camp","Gylia Research Cabin","Gylia Watchtower","Jitak's Farm","Outer Aldorei Town","Aldorei River","Waterfall Cave","Pine Pillar Forest","Burning Farm","Secluded Ponds","Path to Thanos","Kitrios Barracks","Troll's Challenge","Molten Passage","Inhospitable Mountain","Cascading Basins","Winding Waters","Panda Kingdom","Turncoat Turnabout","Perilous Passage","Thanos Underpass","Canyon Walkway","Harpy's Haunt North","Fleris Cranny","Canyon Dropoff","Bandit's Toll","Rocky Bend","Featherfall Cliffs","Hobgoblin's Hoard","Path to the Dojo","Wanderer's Way","Bantisu Approach","Elephelk Trail","Kandon-Beda","Cliffside Passage South","Thesead Underpass","Displaced Housing","Ranol's Farm","Thesead","Eltom","Freezing Heights","Crater Descent","Dragonbone Graveyard","Temple Island","Entamis Village","Delnar Manor","Corkus Castle","Fallen Factory","Corkus City Mine","Industrial Clearing","Picnic Pond","Ava's Workshop","Retrofitted Manufactory","Ruined Houses","Avos Temple","Corkus Outskirts","Sky Castle","Aerial Descent","Old Coal Mine","Astraulus' Tower","Ahmsord Outskirts","Angel Refuge","Central Islands","Sky Falls","Raiders' Airbase","Jofash Docks","Lusuco","Lighthouse Lookout","Cinfras Outskirts","Llevigar","Herb Cave","Icy Island","Fleris Trail","Abandoned Pass","Southern Outpost","Corkus Sea Cove","Broken Road","Grey Ruins","Forest of Eyes","Lutho","Toxic Drip","Gateway to Nothing","Final Step","The Gate","Luminous Plateau","Primal Fen","Otherworldly Monolith","Nexus of Light","Ragni Main Entrance","Katoa Ranch","Coastal Trail","Nomads' Refuge","Little Wood","Road to Time Valley","Alekin","Road to Elkurn","Corrupted Orchard","Jagged Foothills","Half Moon Island","Bob's Tomb","Frozen Homestead","Abandoned Lumberyard","Apprentice Huts","Troms","Ruined Prospect","Barren Sands","Ruined Villa","Dusty Pit","Lava Springs","Nemract","Razed Inn","Bear Zoo","Durum Isles Barn","Pirate Town","Lifeless Forest","Maro Peaks","Ternaves","Abandoned Mines","Plains Lake","Scorched Trail","Sanguine Spider Den","Cinfras","Stonecave Orc Camp","Ogre Den","Forgotten Burrows","Lizardman Camp","Shady Shack","Path to the Grootslangs","Bucie Waterfall","Meteor Crater","Goblin Plains West","Entrance to Bucie","Efilim Crossroads","Wood Sprite Hideaway","Chasm Chokepoint","The Forgery","Mantis Nest","Gelibord","Overtaken Outpost","Lexdale Penitentiary","Mesquis Tower","Dark Forest Village","Fungal Grove","Mushroom Hill","Big Mushroom Cave","Celestial Impact","Gylia Lakehouse","Aldorei Springs","Aldorei Cliffside Waterfalls","Evergreen Outbreak","Thanos","Colourful Mountaintop","Path to Ozoth's Spire","Cyclospordial Hazard","Parasitic Slime Mine","Perilous Grotto","Wizard's Warning","Troll Tower","Wizard Tower","Elefolk Stomping Grounds","Canyon High Path","Bantisu Air Temple","Kandon Farm","Entrance to Thesead","Thesead Suburbs","Dogun Ritual Site","Pyroclastic Flow","Snail Island","Corkus City","Road to Mine","Corkus Forest","Overrun Docks","Founder's Statue","Frozen Fort","Kandon Ridge","Molten Reach","Wybel Island","Raiders' Stronghold","Santa's Hideout","Felroc Fields","Regular Island","Royal Gate","Lost Atoll","Silent Road","Forgotten Town","Paths of Sludge","Void Valley","Heavenly Ingress","Azure Frontier","Entrance to Nivla Woods","Maltic","Abandoned Farm","Arachnid Woods","Detlas","Twain Lake","Nesaak","Troms Lake","Owl Tribe","Almuj","Bremminglar","Nemract Cathedral","Durum Oat Islet","Derelict Mansion","Abandoned Mines Entrance","Essren's Hut","Cliffhearth Orc Camp","Mudspring Orc Camp","Lizardman Lake","Secluded Workshop","Orc Lake","Forgotten Path","Path to the Forgery","Dodegar's Forge","Path to Cinfras","Caritat Mansion","Path to Talor","Heart of Decay","Paper Trail","Gert Camp","Timeworn Arch","Kitrios Armory","Bandit Cave","Wayward Split","Harpy's Haunt South","Housing Crisis","Workshop Glade","Cliffside Passage North","Entrance to Molten Heights","Ahmsord","Corkus City Crossroads","Avos Territory","Bloody Beach","Dragonling Nests","Sky Island Ascent","Icy Descent","Twisted Ridge","Balloon Airbase","Sinister Forest","Bizarre Passage","Path to Light","Ragni Countryside South","Blackstring Den","Nivla Woods Exit","Jungle Entrance","Cascading Oasis","Mount Wynn Inn","Dujgon Nation","Desolate Valley","Meteor Trail","Olux","Loamsprout Orc Camp","Aldorei Valley Outskirts","Castle Dullahan","Old Crossroads","Cosmic Fissures","Burning Airship","Panda Path","Illuminant Path","Protector's Pathway","Lava Lakes","Legendary Island","Path to Ahmsord","Jofash Tunnel","Orc Battlegrounds","Toxic Caves","Pigmen Ravines","Frigid Crossroads","Ternaves Tunnel","Volcanic Excavation","Maiden Tower","Road to Light Forest","Entrance to Kander","Aldorei Valley","Thanos Exit","Cherry Blossom Grove","Relos","Rodoroc","Field of Life","Roots of Corruption","Zhight Island","Harnort Compound","Fallen Village","Krolton's Cave","Swamp Island","Sunrise Plateau","Mycelial Expanse","Fountain of Youth","Entrance to Gavel","Worm Tunnel","Upper Thanos","Light Peninsula"]
